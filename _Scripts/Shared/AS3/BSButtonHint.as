package Shared.AS3
{
    ...
    public dynamic class BSButtonHint extends BSUIComponent
    {
        ...
        private static const NameToTextMap:Object = {"Xenon_A": "A",
                "Xenon_B": "B",
                "Xenon_X": "C",
                "Xenon_Y": "D",
                "Xenon_Select": "E",
        ...
        private static const FRtoENMap:Object = {"A": "Q",
                "Q": "A",
                "W": "Z",
                "Z": "W",
                "-": ")"};

        private static const BEtoENMap:Object = {"A": "Q",
                "Q": "A",
                "W": "Z",
                "Z": "W",
                "-": ")",
        ...
        {
            return uiPlatform == PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && !NameToTextMap.hasOwnProperty(this._buttonHintData.PCKey);
        }

        public function get ControllerButton():String
        {
            var _loc1_:String = "";
            if (uiPlatform != PlatformChangeEvent.PLATFORM_MOBILE && this.UsePCKey)
            {
                _loc1_ = this.PCKey;
            }
            else
        ...
        override public function redrawUIComponent():void
        {
            ...
            if (visible)
            {
                ...
                if (this.m_CanHold && this.HoldMeter_mc != null)
                {
